          ...
          <div className="p-6 flex flex-col gap-4 h-full">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant={getStatusColor(edition.status) as any}>{edition.status}</Badge>
              ...
              {edition.registrationDeadline && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p
                      className={
                        isPast(new Date(edition.registrationDeadline))
                          ? 'text-red-600'
                          : 'text-slate-600'
                      }
                    >
                      ...
                      {isClient && !isPast(new Date(edition.registrationDeadline)) && (
                        <span className="ml-2 text-xs">
                          (
                          {formatDistanceToNow(new Date(edition.registrationDeadline), {
                            addSuffix: true,
                          })}
                          )
                        </span>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      ...
                      {edition.eventEnd &&
                        ` - ${format(new Date(edition.eventEnd), 'MMM d, yyyy')}`}
                    </p>
                  </div>
                </div>
              )}
            ...
            {edition.popularityScore > 50 && (
              <div className="text-xs text-slate-500 flex items-center gap-2">
                <span>🔥</span>
                <span>
                  {edition.savesCount} saves • {edition.followsCount} following
                </span>
              </div>
            )}
          </div>
