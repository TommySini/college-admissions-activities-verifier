...
export const NavItemBase = ({
  ...
  const iconElement = Icon && (
    <Icon aria-hidden="true" className="mr-2 size-5 shrink-0 text-black transition-inherit-all" />
  );
  ...
  if (type === 'collapsible') {
    return (
      ...
      >
        ...
        <ChevronDown
          aria-hidden="true"
          className="ml-3 size-4 shrink-0 stroke-[2.5px] text-black in-open:-scale-y-100"
        />
      </summary>
    );
  }
