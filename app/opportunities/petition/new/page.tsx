    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <Card className="max-w-md w-full p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Petition Submitted!</h2>
          <p className="text-slate-600 mb-6">
            Thank you for suggesting this opportunity. Our team will review it and add it to the
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Suggest an Opportunity</h1>
          <p className="text-slate-600">
            Know of a competition, program, or opportunity that's missing? Help us build the most
            comprehensive database for high school students.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 border-t border-slate-200">
              <p className="text-sm text-slate-600 mb-4">
                By submitting, you confirm that this is a legitimate opportunity for high school
                students and you're providing accurate information.
              </p>
              <div className="flex gap-3">
