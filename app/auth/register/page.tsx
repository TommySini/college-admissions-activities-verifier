    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="bg-black/5 backdrop-blur-xl rounded-2xl p-8 max-w-2xl w-full shadow-2xl border border-black/10 max-h-[90vh] overflow-y-auto">
          ...
          <p className="text-black/60 mb-6">Create a new account to get started</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-black mb-1">Profile Type *</label>
              <select
                required
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    profileType: e.target.value as 'Applicant' | 'Organization',
                  })
                }
